          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-600">
                By accessing and using GapFinder ("Service"), you accept and agree to be bound by 
            ...
            <section>
              ...
              <p className="text-gray-600 mb-4">
                GapFinder is an AI-powered platform that provides market gap analysis and innovation 
            ...
            <section>
              ...
              <p className="text-gray-600">
                GapFinder provides market analysis for informational purposes only. We do not guarantee 
            ...
            <section>
              ...
              <p className="text-gray-600">
                ...
                <a href="mailto:legal@gapfinder.com" className="text-blue-600 hover:underline ml-1">
                  legal@gapfinder.com
                </a>
              </p>
            </section>
